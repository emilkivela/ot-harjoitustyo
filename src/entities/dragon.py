...
class Dragon(pygame.sprite.Sprite):
    """Object to take care of the skeleton dragon-type enemies
    ...
    def __init__(self, x=0, y=0):
        """The constructor that makes a Dragon object

        Args:
            x (int, optional): X-coordinates for the dragon. Defaults to 0.
            y (int, optional): Y-coordinates for the dragon. Defaults to 0.
        """
        super().__init__()
        self.cooldown = False
        self.image = load_image("big_dragon.png")
        self.health = 6
    ...
    def should_shoot(self, current_time):
        return current_time - self.previous_shoot_time >= 2000
